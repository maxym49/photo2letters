            ...
            <>
                <BackgroundContainer resizeMode="contain">
                    ...
                    <ContentWrapper>
                        ...
                        <Button action={this.onMakePhotoPress.bind(this)} shadow
                        ...
                        <Text
                            style={{
                                ...
                                fontWeight: '300',
                                color: GREY
                            }}>{MAIN_IMPORT_PAGE_BETWEEN_BUTTONS}</Text>
                        <Button action={this.onUploadPress.bind(this)} text={MAIN_IMPORT_PAGE_UPLOAD_PHOTO_BUTTON}
                                btnStyle={{
