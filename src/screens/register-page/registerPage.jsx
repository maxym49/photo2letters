...
export default class RegisterPage extends Component {
    ...
    componentDidMount() {
        console.log(!this.state.email.length && !this.state.password.length && !this.state.rePassword.length && this.state.passValid)
    }
            ...
            <>
                <BackgroundContainer>
                    ...
                    <ContentWrapper style={{
                        ...
                        <Input text={password} action={this.onPasswordChange} security
                               placeholder={PASSWORD_INPUT_PLACEHOLDER}/>
                        <Input text={rePassword} action={this.onRePasswordChange} security
                               placeholder={RE_TYPE_PASSWORD_INPUT_PLACEHOLDER}/>
                        <Button disabled={formNotValid}
                                action={this.onRegisterPress.bind(this)} shadow
