            ...
            <>
                <BackgroundContainer>
                    ...
                    <ContentWrapper style={{
                        ...
                        <Button action={this.onLoginPress.bind(this)} shadow text={START_PAGE_LOGIN_TO_ACCOUNT_BUTTON_TEXT}
                                btnStyle={{
                                    backgroundColor: PRIMARY,
                                    marginTop: 30
                                }}/>
                        <Button action={this.onForgotPasswordPress.bind(this)} text={LOGIN_PAGE_FORGOT_PASSWORD} btnStyle={{
